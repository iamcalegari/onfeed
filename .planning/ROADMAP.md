...
- [x] 05-02-PLAN.md — promoteImportToPublic (visibility flip, source kept) + widened maybePromote (confidence+confirmedAt gate, owner self-like excluded) (SOC-04/05)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 05-03-PLAN.md — shareSlug gen at confirm + getRecipeByShareSlug + public GET /recipes/share/:token (no existence leak, IDOR-safe) (SOC-01/02)
...
- [x] 05-05-PLAN.md — public /r/[token] Next page + middleware allowlist + LikeButton sign-in redirect + ShareButton token wiring (SOC-02/03)
