  ...
  return (
    ...
    >
      ...
      >
        ...
        {isVariant && (
          <div
            className="variant-glow flex items-start gap-3 rounded-2xl p-4 mb-4"
            style={{
              background:
                "linear-gradient(135deg,rgba(180,140,60,.10) 0%,rgba(200,165,80,.06) 100%)",
            }}
          >
